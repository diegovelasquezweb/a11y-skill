...
<body class="text-slate-900 min-h-screen">
  ...
  <div class="max-w-4xl mx-auto px-4 pt-24 pb-20">
    ...
    <div class="mb-12">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        ...
        <div class="bg-white rounded-2xl border border-amber-100 p-5 shadow-sm">
          ...
          <div class="text-xs font-bold text-amber-600 uppercase tracking-widest mb-2">WCAG AA</div>
    ...
    <footer class="mt-12 py-6 border-t border-slate-200 text-center">
      <p class="text-slate-400 text-sm font-medium">Generated by <a href="https://github.com/diegovelasquezweb/a11y" target="_blank" class="text-slate-500 hover:text-amber-600 font-semibold transition-colors">a11y</a> &bull; <span class="text-slate-500">WCAG 2.2 AA</span></p>
    </footer>
