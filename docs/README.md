...
Welcome to the internal technical reference for the **a11y** skill. This directory contains detailed manuals for developers, maintainers, and system integrators.

## Navigation Index

| Manual                                               | Description                                                                   |
| :--------------------------------------------------- | :---------------------------------------------------------------------------- |
| 🏗️ [**Architecture**](architecture.md)               | High-level pipeline flow (Scanner → Analyzer → Builder) and Mermaid diagrams. |
...
If you are looking to contribute code or documentation to this skill, please refer to the [CONTRIBUTING.md](../CONTRIBUTING.md) in the project root.
