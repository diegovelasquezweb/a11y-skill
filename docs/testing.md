...
- **Field Normalization**: Verifies that `falsePositiveRisk`, `fixDifficultyNotes`, `frameworkNotes`, `guardrails`, and `relatedRules` are correctly mapped and default safely when absent.
