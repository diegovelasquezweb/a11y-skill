...
6. If the user asks you to fix or resolve the violations, immediately read `audit/remediation.md`. Follow the instructions inside that file precisely, grouping your code edits by page/route as directed.
