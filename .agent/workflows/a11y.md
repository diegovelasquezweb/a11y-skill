...
6. If the user asks for fixes, read `audit/remediation.md`. Follow the instructions inside that file precisely, grouping your code edits by page/route as directed.
